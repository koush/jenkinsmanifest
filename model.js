...
setting.get('model_version', function(version) {
  if (version == null) {
    ...
    mysql.query('create table if not exists releases (build int not null, modversion varchar(64) primary key not null, device varchar(32) not null, filename varchar(256) not null, date bigint not null)');
